...
var Preparer_1 = require("./Preparer");
...
var Notifier = /** @class */ (function () {
    ...
    Notifier.send = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var preparer, sender, preparedMessage;
            return __generator(this, function (_a) {
                preparer = new Preparer_1["default"]();
                sender = new Sender_1["default"]();
                preparedMessage = message.fee
                    ? preparer.prepareError(message, message.fee)
                    : preparer.prepareMessage(message);
                sender.send(preparedMessage).then(function (result) {
